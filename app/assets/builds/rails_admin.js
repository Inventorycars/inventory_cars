  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global, factory) {
        ...
        var version = "3.7.1", rhtmlSuffix = /HTML$/i, jQuery11 = function(selector, context) {
          return new jQuery11.fn.init(selector, context);
        };
        jQuery11.fn = jQuery11.prototype = {
          // The current version of jQuery being used
          jquery: version,
          constructor: jQuery11,
          ...
          pushStack: function(elems) {
            var ret = jQuery11.merge(this.constructor(), elems);
            ret.prevObject = this;
            return ret;
          },
          // Execute a callback for every element in the matched set.
          each: function(callback) {
            return jQuery11.each(this, callback);
          },
          map: function(callback) {
            return this.pushStack(jQuery11.map(this, function(elem, i) {
          ...
          even: function() {
            return this.pushStack(jQuery11.grep(this, function(_elem, i) {
              return (i + 1) % 2;
            }));
          },
          odd: function() {
        ...
        jQuery11.extend = jQuery11.fn.extend = function() {
          ...
          for (; i < length; i++) {
            if ((options = arguments[i]) != null) {
              for (name in options) {
                ...
                if (deep && copy && (jQuery11.isPlainObject(copy) || (copyIsArray = Array.isArray(copy)))) {
                  src = target[name];
                  if (copyIsArray && !Array.isArray(src)) {
                    clone = [];
                  } else if (!copyIsArray && !jQuery11.isPlainObject(src)) {
                    clone = {};
                  } else {
                    clone = src;
                  }
                  copyIsArray = false;
                  target[name] = jQuery11.extend(deep, clone, copy);
                } else if (copy !== void 0) {
                  target[name] = copy;
                }
              }
        ...
        if (typeof Symbol === "function") {
          jQuery11.fn[Symbol.iterator] = arr[Symbol.iterator];
        }
        jQuery11.each(
        ...
        jQuery11.contains = function(a, b) {
        ...
        jQuery11.escapeSelector = function(sel) {
          return (sel + "").replace(rcssescape, fcssescape);
        };
        var preferredDoc = document2, pushNative = push;
        (function() {
          var i, Expr, outermostContext, sortInput, hasDuplicate, push2 = pushNative, document3, documentElement2, documentIsHTML, rbuggyQSA, matches, expando = jQuery11.expando, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
            if (a === b) {
              hasDuplicate = true;
            }
            return 0;
                  ...
                  if (nodeType === 1 && (rdescend.test(selector) || rleadingCombinator.test(selector))) {
                    ...
                    if (newContext != context || !support.scope) {
                      if (nid = context.getAttribute("id")) {
                        nid = jQuery11.escapeSelector(nid);
                      } else {
          ...
          function setDocument(node) {
            ...
            documentIsHTML = !jQuery11.isXMLDoc(document3);
            ...
            support.getById = assert(function(el) {
              documentElement2.appendChild(el).id = jQuery11.expando;
              return !document3.getElementsByName || !document3.getElementsByName(jQuery11.expando).length;
            });
          ...
          find.contains = function(context, elem) {
            ...
            return jQuery11.contains(context, elem);
          };
          ...
          jQuery11.uniqueSort = function(results) {
          ...
          jQuery11.fn.uniqueSort = function() {
            return this.pushStack(jQuery11.uniqueSort(slice.apply(this)));
          };
          Expr = jQuery11.expr = {
            ...
            pseudos: {
              ...
              contains: markFunction(function(text) {
                ...
                return function(elem) {
                  return (elem.textContent || jQuery11.text(elem)).indexOf(text) > -1;
                };
              }),
          ...
          jQuery11.find = find;
          jQuery11.expr[":"] = jQuery11.expr.pseudos;
          jQuery11.unique = jQuery11.uniqueSort;
          find.compile = compile;
          find.select = select;
          find.setDocument = setDocument;
          find.tokenize = tokenize;
          find.escape = jQuery11.escapeSelector;
          find.getText = jQuery11.text;
          find.isXML = jQuery11.isXMLDoc;
          find.selectors = jQuery11.expr;
          find.support = jQuery11.support;
          find.uniqueSort = jQuery11.uniqueSort;
        })();
        var dir = function(elem, dir2, until) {
          var matched = [], truncate = until !== void 0;
          while ((elem = elem[dir2]) && elem.nodeType !== 9) {
            if (elem.nodeType === 1) {
              if (truncate && jQuery11(elem).is(until)) {
                break;
              }
              matched.push(elem);
            }
        ...
        var rneedsContext = jQuery11.expr.match.needsContext;
        var rsingleTag = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
        function winnow(elements, qualifier, not) {
          if (isFunction(qualifier)) {
            return jQuery11.grep(elements, function(elem, i) {
              return !!qualifier.call(elem, i, elem) !== not;
            });
          }
          if (qualifier.nodeType) {
            return jQuery11.grep(elements, function(elem) {
          ...
          return jQuery11.filter(qualifier, elements, not);
        }
        jQuery11.filter = function(expr, elems, not) {
          var elem = elems[0];
          if (not) {
            expr = ":not(" + expr + ")";
          }
          if (elems.length === 1 && elem.nodeType === 1) {
            return jQuery11.find.matchesSelector(elem, expr) ? [elem] : [];
          }
          return jQuery11.find.matches(expr, jQuery11.grep(elems, function(elem2) {
        ...
        jQuery11.fn.extend({
          find: function(selector) {
            ...
            if (typeof selector !== "string") {
              return this.pushStack(jQuery11(selector).filter(function() {
                for (i = 0; i < len; i++) {
                  if (jQuery11.contains(self2[i], this)) {
                    return true;
                  }
                }
              }));
            ...
            ret = this.pushStack([]);
            for (i = 0; i < len; i++) {
              jQuery11.find(selector, self2[i], ret);
            }
            return len > 1 ? jQuery11.uniqueSort(ret) : ret;
          },
          ...
          is: function(selector) {
            return !!winnow(
              ...
              typeof selector === "string" && rneedsContext.test(selector) ? jQuery11(selector) : selector || [],
              false
            ).length;
          }
        });
        var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init = jQuery11.fn.init = function(selector, context, root) {
          var match, elem;
          if (!selector) {
            return this;
          }
          ...
          if (typeof selector === "string") {
            ...
            if (match && (match[1] || !context)) {
              if (match[1]) {
                context = context instanceof jQuery11 ? context[0] : context;
                jQuery11.merge(this, jQuery11.parseHTML(
                  match[1],
                  context && context.nodeType ? context.ownerDocument || context : document2,
                  true
                ));
                if (rsingleTag.test(match[1]) && jQuery11.isPlainObject(context)) {
          ...
          return jQuery11.makeArray(selector, this);
        };
        init.prototype = jQuery11.fn;
        rootjQuery = jQuery11(document2);
        ...
        jQuery11.fn.extend({
          has: function(target) {
            var targets = jQuery11(target, this), l = targets.length;
            return this.filter(function() {
              var i = 0;
              for (; i < l; i++) {
                if (jQuery11.contains(this, targets[i])) {
                  return true;
                }
              }
            });
          ...
          closest: function(selectors, context) {
            var cur, i = 0, l = this.length, matched = [], targets = typeof selectors !== "string" && jQuery11(selectors);
            if (!rneedsContext.test(selectors)) {
              for (; i < l; i++) {
                for (cur = this[i]; cur && cur !== context; cur = cur.parentNode) {
                  if (cur.nodeType < 11 && (targets ? targets.index(cur) > -1 : (
                    // Don't pass non-elements to jQuery#find
                    cur.nodeType === 1 && jQuery11.find.matchesSelector(cur, selectors)
                  ))) {
                    matched.push(cur);
                    break;
                  }
            ...
            return this.pushStack(matched.length > 1 ? jQuery11.uniqueSort(matched) : matched);
          },
          ...
          index: function(elem) {
            ...
            if (typeof elem === "string") {
              return indexOf2.call(jQuery11(elem), this[0]);
            }
          ...
          add: function(selector, context) {
            return this.pushStack(
              jQuery11.uniqueSort(
                jQuery11.merge(this.get(), jQuery11(selector, context))
              )
            );
          },
        ...
        jQuery11.each({
          ...
          contents: function(elem) {
            ...
            return jQuery11.merge([], elem.childNodes);
          }
        }, function(name, fn2) {
          jQuery11.fn[name] = function(until, selector) {
            var matched = jQuery11.map(this, fn2, until);
            if (name.slice(-5) !== "Until") {
              selector = until;
            }
            if (selector && typeof selector === "string") {
              matched = jQuery11.filter(selector, matched);
            }
            if (this.length > 1) {
              if (!guaranteedUnique[name]) {
                jQuery11.uniqueSort(matched);
              }
        ...
        function createOptions(options) {
          var object = {};
          jQuery11.each(options.match(rnothtmlwhite) || [], function(_, flag) {
            object[flag] = true;
          });
          return object;
        }
        jQuery11.Callbacks = function(options) {
          options = typeof options === "string" ? createOptions(options) : jQuery11.extend({}, options);
          var firing, memory, fired, locked, list = [], queue = [], firingIndex = -1, fire = function() {
            ...
            add: function() {
              if (list) {
                ...
                (function add(args) {
                  jQuery11.each(args, function(_, arg) {
                    if (isFunction(arg)) {
            ...
            remove: function() {
              jQuery11.each(arguments, function(_, arg) {
                var index;
                while ((index = jQuery11.inArray(arg, list, index)) > -1) {
                  list.splice(index, 1);
            ...
            has: function(fn2) {
              return fn2 ? jQuery11.inArray(fn2, list) > -1 : list.length > 0;
            },
        ...
        jQuery11.extend({
          Deferred: function(func) {
            var tuples = [
              ...
              [
                "resolve",
                "done",
                jQuery11.Callbacks("once memory"),
                jQuery11.Callbacks("once memory"),
                0,
                "resolved"
              ],
              ...
              pipe: function() {
                var fns = arguments;
                return jQuery11.Deferred(function(newDefer) {
                  jQuery11.each(tuples, function(_i, tuple) {
                  ...
                  return function() {
                    var that = this, args = arguments, mightThrow = function() {
                      ...
                      try {
                        ...
                        if (jQuery11.Deferred.exceptionHook) {
                          jQuery11.Deferred.exceptionHook(
                            e,
                            process.error
                          );
                        }
                    ...
                    if (depth) {
                      ...
                      if (jQuery11.Deferred.getErrorHook) {
                        process.error = jQuery11.Deferred.getErrorHook();
                      } else if (jQuery11.Deferred.getStackHook) {
                        process.error = jQuery11.Deferred.getStackHook();
                      }
              ...
              promise: function(obj) {
                return obj != null ? jQuery11.extend(obj, promise) : promise;
              }
            }, deferred = {};
            jQuery11.each(tuples, function(i, tuple) {
          ...
          when: function(singleValue) {
            var remaining = arguments.length, i = remaining, resolveContexts = Array(i), resolveValues = slice.call(arguments), primary = jQuery11.Deferred(), updateFunc = function(i2) {
        ...
        jQuery11.Deferred.exceptionHook = function(error, asyncError) {
        ...
        jQuery11.readyException = function(error) {
          window2.setTimeout(function() {
            throw error;
          });
        };
        var readyList = jQuery11.Deferred();
        jQuery11.fn.ready = function(fn2) {
          readyList.then(fn2).catch(function(error) {
            jQuery11.readyException(error);
          });
          return this;
        };
        jQuery11.extend({
          ...
          ready: function(wait) {
            if (wait === true ? --jQuery11.readyWait : jQuery11.isReady) {
              return;
            }
            jQuery11.isReady = true;
            if (wait !== true && --jQuery11.readyWait > 0) {
              return;
            }
            readyList.resolveWith(document2, [jQuery11]);
          }
        });
        jQuery11.ready.then = readyList.then;
        function completed() {
        ...
        if (document2.readyState === "complete" || document2.readyState !== "loading" && !document2.documentElement.doScroll) {
          window2.setTimeout(jQuery11.ready);
        } else {
            ...
            if (bulk) {
              if (raw) {
                ...
                fn2 = function(elem, _key, value2) {
                  return bulk.call(jQuery11(elem), value2);
                };
              }
            }
            if (fn2) {
        ...
        function Data2() {
          this.expando = jQuery11.expando + Data2.uid++;
        }
        Data2.uid = 1;
        Data2.prototype = {
          ...
          remove: function(owner, key) {
            ...
            if (key === void 0 || jQuery11.isEmptyObject(cache2)) {
              if (owner.nodeType) {
          ...
          hasData: function(owner) {
            ...
            return cache2 !== void 0 && !jQuery11.isEmptyObject(cache2);
          }
        };
        ...
        jQuery11.extend({
            ...
            if (elem) {
              ...
              if (data) {
                if (!queue || Array.isArray(data)) {
                  queue = dataPriv.access(elem, type, jQuery11.makeArray(data));
                } else {
                  queue.push(data);
                }
              }
          ...
          dequeue: function(elem, type) {
            type = type || "fx";
            var queue = jQuery11.queue(elem, type), startLength = queue.length, fn2 = queue.shift(), hooks = jQuery11._queueHooks(elem, type), next = function() {
              jQuery11.dequeue(elem, type);
            };
            if (fn2 === "inprogress") {
              fn2 = queue.shift();
              startLength--;
          ...
          _queueHooks: function(elem, type) {
            ...
            return dataPriv.get(elem, key) || dataPriv.access(elem, key, {
              empty: jQuery11.Callbacks("once memory").add(function() {
        ...
        jQuery11.fn.extend({
          queue: function(type, data) {
            ...
            if (arguments.length < setter) {
              return jQuery11.queue(this[0], type);
            }
            return data === void 0 ? this : this.each(function() {
              var queue = jQuery11.queue(this, type, data);
              jQuery11._queueHooks(this, type);
              if (type === "fx" && queue[0] !== "inprogress") {
                jQuery11.dequeue(this, type);
              }
            });
          },
          ...
          promise: function(type, obj) {
            var tmp, count = 1, defer = jQuery11.Deferred(), elements = this, i = this.length, resolve = function() {
              if (!--count) {
        ...
        var isAttached = function(elem) {
          return jQuery11.contains(elem.ownerDocument, elem);
        }, composed = { composed: true };
        if (documentElement.getRootNode) {
          isAttached = function(elem) {
            return jQuery11.contains(elem.ownerDocument, elem) || elem.getRootNode(composed) === elem.ownerDocument;
          };
        }
        var isHiddenWithinTree = function(elem, el) {
          ...
          // in the document.
          isAttached(elem) && jQuery11.css(elem, "display") === "none";
        };
        function adjustCSS(elem, prop, valueParts, tween) {
          var adjusted, scale, maxIterations = 20, currentValue = tween ? function() {
            return tween.cur();
          } : function() {
            return jQuery11.css(elem, prop, "");
          }, initial = currentValue(), unit = valueParts && valueParts[3] || (jQuery11.cssNumber[prop] ? "" : "px"), initialInUnit = elem.nodeType && (jQuery11.cssNumber[prop] || unit !== "px" && +initial) && rcssNum.exec(jQuery11.css(elem, prop));
          if (initialInUnit && initialInUnit[3] !== unit) {
            initial = initial / 2;
            unit = unit || initialInUnit[3];
            initialInUnit = +initial || 1;
            while (maxIterations--) {
              jQuery11.style(elem, prop, initialInUnit + unit);
        ...
        function getDefaultDisplay(elem) {
          ...
          display = jQuery11.css(temp, "display");
        ...
        function getAll(context, tag) {
          ...
          if (tag === void 0 || tag && nodeName(context, tag)) {
            return jQuery11.merge([context], ret);
          }
          return ret;
        }
        ...
        function buildFragment(elems, context, scripts, selection, ignored) {
          ...
          for (; i < l; i++) {
            ...
            if (elem || elem === 0) {
              if (toType2(elem) === "object") {
                jQuery11.merge(nodes, elem.nodeType ? [elem] : elem);
                ...
                tmp.innerHTML = wrap[1] + jQuery11.htmlPrefilter(elem) + wrap[2];
                j = wrap[0];
                while (j--) {
                  tmp = tmp.lastChild;
                }
                jQuery11.merge(nodes, tmp.childNodes);
          ...
          i = 0;
          while (elem = nodes[i++]) {
            if (selection && jQuery11.inArray(elem, selection) > -1) {
              if (ignored) {
                ignored.push(elem);
              }
              continue;
        ...
        function on(elem, types, selector, data, fn2, one) {
          ...
          if (one === 1) {
            ...
            fn2.guid = origFn.guid || (origFn.guid = jQuery11.guid++);
          }
          return elem.each(function() {
            jQuery11.event.add(this, types, fn2, data, selector);
          });
        }
        jQuery11.event = {
          global: {},
          add: function(elem, types, handler, data, selector) {
            ...
            if (selector) {
              jQuery11.find.matchesSelector(documentElement, selector);
            }
            if (!handler.guid) {
              handler.guid = jQuery11.guid++;
            }
            ...
            if (!(eventHandle = elemData.handle)) {
              eventHandle = elemData.handle = function(e) {
                return typeof jQuery11 !== "undefined" && jQuery11.event.triggered !== e.type ? jQuery11.event.dispatch.apply(elem, arguments) : void 0;
              };
            }
            ...
            while (t--) {
              ...
              special = jQuery11.event.special[type] || {};
              type = (selector ? special.delegateType : special.bindType) || type;
              special = jQuery11.event.special[type] || {};
              handleObj = jQuery11.extend({
                type,
                origType,
                data,
                handler,
                guid: handler.guid,
                selector,
                needsContext: selector && jQuery11.expr.match.needsContext.test(selector),
              ...
              jQuery11.event.global[type] = true;
            }
          },
          ...
          remove: function(elem, types, handler, selector, mappedTypes) {
            ...
            while (t--) {
              ...
              if (!type) {
                for (type in events) {
                  jQuery11.event.remove(elem, type + types[t], handler, selector, true);
                }
                continue;
              }
              special = jQuery11.event.special[type] || {};
              ...
              if (origCount && !handlers.length) {
                if (!special.teardown || special.teardown.call(elem, namespaces, elemData.handle) === false) {
                  jQuery11.removeEvent(elem, type, elemData.handle);
                }
                delete events[type];
              }
            }
            if (jQuery11.isEmptyObject(events)) {
              dataPriv.remove(elem, "handle events");
            }
          },
          dispatch: function(nativeEvent) {
            var i, j, ret, matched, handleObj, handlerQueue, args = new Array(arguments.length), event = jQuery11.event.fix(nativeEvent), handlers = (dataPriv.get(this, "events") || /* @__PURE__ */ Object.create(null))[event.type] || [], special = jQuery11.event.special[event.type] || {};
            args[0] = event;
            ...
            handlerQueue = jQuery11.event.handlers.call(this, event, handlers);
            i = 0;
            while ((matched = handlerQueue[i++]) && !event.isPropagationStopped()) {
              ...
              while ((handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped()) {
                if (!event.rnamespace || handleObj.namespace === false || event.rnamespace.test(handleObj.namespace)) {
                  ...
                  ret = ((jQuery11.event.special[handleObj.origType] || {}).handle || handleObj.handler).apply(matched.elem, args);
                  if (ret !== void 0) {
                ...
                if (cur.nodeType === 1 && !(event.type === "click" && cur.disabled === true)) {
                  ...
                  for (i = 0; i < delegateCount; i++) {
                    ...
                    if (matchedSelectors[sel] === void 0) {
                      matchedSelectors[sel] = handleObj.needsContext ? jQuery11(sel, this).index(cur) > -1 : jQuery11.find(sel, this, null, [cur]).length;
                    }
          ...
          addProp: function(name, hook) {
            Object.defineProperty(jQuery11.Event.prototype, name, {
              enumerable: true,
              configurable: true,
          ...
          fix: function(originalEvent) {
            return originalEvent[jQuery11.expando] ? originalEvent : new jQuery11.Event(originalEvent);
          },
          special: {
            load: {
        ...
        function leverageNative(el, type, isSetup) {
          if (!isSetup) {
            if (dataPriv.get(el, type) === void 0) {
              jQuery11.event.add(el, type, returnTrue);
            }
            return;
          }
          dataPriv.set(el, type, false);
          jQuery11.event.add(el, type, {
            namespace: false,
            handler: function(event) {
              ...
              if (event.isTrigger & 1 && this[type]) {
                ...
                } else if ((jQuery11.event.special[type] || {}).delegateType) {
                  event.stopPropagation();
                }
              } else if (saved) {
                dataPriv.set(this, type, jQuery11.event.trigger(
                  saved[0],
                  saved.slice(1),
                  this
                ));
        ...
        jQuery11.removeEvent = function(elem, type, handle) {
          if (elem.removeEventListener) {
            elem.removeEventListener(type, handle);
          }
        };
        jQuery11.Event = function(src, props) {
          if (!(this instanceof jQuery11.Event)) {
            return new jQuery11.Event(src, props);
          }
          if (src && src.type) {
          ...
          if (props) {
            jQuery11.extend(this, props);
          }
          this.timeStamp = src && src.timeStamp || Date.now();
          this[jQuery11.expando] = true;
        };
        jQuery11.Event.prototype = {
          constructor: jQuery11.Event,
        ...
        jQuery11.each({
          ...
          touches: true,
          which: true
        }, jQuery11.event.addProp);
        jQuery11.each({ focus: "focusin", blur: "focusout" }, function(type, delegateType) {
          function focusMappedHandler(nativeEvent) {
            if (document2.documentMode) {
              var handle = dataPriv.get(this, "handle"), event = jQuery11.event.fix(nativeEvent);
              ...
              jQuery11.event.simulate(
                delegateType,
                nativeEvent.target,
                jQuery11.event.fix(nativeEvent)
              );
            }
          }
          jQuery11.event.special[type] = {
          ...
          jQuery11.event.special[delegateType] = {
            setup: function() {
        ...
        jQuery11.each({
          ...
          jQuery11.event.special[orig] = {
            delegateType: fix,
            bindType: fix,
            handle: function(event) {
              var ret, target = this, related = event.relatedTarget, handleObj = event.handleObj;
              if (!related || related !== target && !jQuery11.contains(target, related)) {
        ...
        jQuery11.fn.extend({
          ...
          off: function(types, selector, fn2) {
            ...
            if (types && types.preventDefault && types.handleObj) {
              ...
              jQuery11(types.delegateTarget).off(
            ...
            return this.each(function() {
              jQuery11.event.remove(this, types, fn2, selector);
            });
          }
        });
        ...
        function manipulationTarget(elem, content) {
          if (nodeName(elem, "table") && nodeName(content.nodeType !== 11 ? content : content.firstChild, "tr")) {
            return jQuery11(elem).children("tbody")[0] || elem;
          }
          return elem;
        }
        ...
        function cloneCopyEvent(src, dest) {
            ...
            if (events) {
              ...
              for (type in events) {
                for (i = 0, l = events[type].length; i < l; i++) {
                  jQuery11.event.add(dest, type, events[type][i]);
                }
              }
            }
          }
          if (dataUser.hasData(src)) {
            ...
            udataCur = jQuery11.extend({}, udataOld);
        ...
        function domManip(collection, args, callback, ignored) {
          ...
          if (l) {
            ...
            if (first || ignored) {
              scripts = jQuery11.map(getAll(fragment, "script"), disableScript);
              hasScripts = scripts.length;
              for (; i < l; i++) {
                node = fragment;
                if (i !== iNoClone) {
                  node = jQuery11.clone(node, true, true);
                  if (hasScripts) {
                    jQuery11.merge(scripts, getAll(node, "script"));
                  }
                }
              ...
              if (hasScripts) {
                ...
                jQuery11.map(scripts, restoreScript);
                for (i = 0; i < hasScripts; i++) {
                  node = scripts[i];
                  if (rscriptType.test(node.type || "") && !dataPriv.access(node, "globalEval") && jQuery11.contains(doc, node)) {
                    if (node.src && (node.type || "").toLowerCase() !== "module") {
                      if (jQuery11._evalUrl && !node.noModule) {
                        jQuery11._evalUrl(node.src, {
        ...
        function remove(elem, selector, keepData) {
          var node, nodes = selector ? jQuery11.filter(selector, elem) : elem, i = 0;
          for (; (node = nodes[i]) != null; i++) {
            if (!keepData && node.nodeType === 1) {
              jQuery11.cleanData(getAll(node));
            }
            if (node.parentNode) {
        ...
        jQuery11.extend({
          ...
          clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            if (!support.noCloneChecked && (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery11.isXMLDoc(elem)) {
          ...
          cleanData: function(elems) {
            var data, elem, type, special = jQuery11.event.special, i = 0;
                ...
                if (data = elem[dataPriv.expando]) {
                  if (data.events) {
                    for (type in data.events) {
                      if (special[type]) {
                        jQuery11.event.remove(elem, type);
                      } else {
                        jQuery11.removeEvent(elem, type, data.handle);
                      }
                    }
                  }
        ...
        jQuery11.fn.extend({
          ...
          text: function(value) {
            return access(this, function(value2) {
              return value2 === void 0 ? jQuery11.text(this) : this.empty().each(function() {
          ...
          empty: function() {
            ...
            for (; (elem = this[i]) != null; i++) {
              if (elem.nodeType === 1) {
                jQuery11.cleanData(getAll(elem, false));
                elem.textContent = "";
              }
            }
            return this;
          ...
          clone: function(dataAndEvents, deepDataAndEvents) {
            ...
            return this.map(function() {
              return jQuery11.clone(this, dataAndEvents, deepDataAndEvents);
            });
          },
          html: function(value) {
            return access(this, function(value2) {
              ...
              if (typeof value2 === "string" && !rnoInnerhtml.test(value2) && !wrapMap[(rtagName.exec(value2) || ["", ""])[1].toLowerCase()]) {
                value2 = jQuery11.htmlPrefilter(value2);
                try {
                  for (; i < l; i++) {
                    elem = this[i] || {};
                    if (elem.nodeType === 1) {
          ...
          replaceWith: function() {
            ...
            return domManip(this, arguments, function(elem) {
              ...
              if (jQuery11.inArray(this, ignored) < 0) {
                jQuery11.cleanData(getAll(this));
                if (parent) {
        ...
        jQuery11.each({
          ...
          jQuery11.fn[name] = function(selector) {
            var elems, ret = [], insert = jQuery11(selector), last = insert.length - 1, i = 0;
            for (; i <= last; i++) {
              elems = i === last ? this : this.clone(true);
              jQuery11(insert[i])[original](elems);
        ...
        function finalPropName(name) {
          var final = jQuery11.cssProps[name] || vendorProps[name];
          if (final) {
            return final;
          }
          if (name in emptyStyle) {
        ...
        function boxModelAdjustment(elem, dimension, box, isBorderBox, styles, computedVal) {
          ...
          for (; i < 4; i += 2) {
            if (box === "margin") {
              marginDelta += jQuery11.css(elem, box + cssExpand[i], true, styles);
            }
            if (!isBorderBox) {
              delta += jQuery11.css(elem, "padding" + cssExpand[i], true, styles);
              if (box !== "padding") {
                delta += jQuery11.css(elem, "border" + cssExpand[i] + "Width", true, styles);
              } else {
                extra += jQuery11.css(elem, "border" + cssExpand[i] + "Width", true, styles);
              }
            } else {
              if (box === "content") {
                delta -= jQuery11.css(elem, "padding" + cssExpand[i], true, styles);
        ...
        function getWidthOrHeight(elem, dimension, extra) {
          var styles = getStyles(elem), boxSizingNeeded = !support.boxSizingReliable() || extra, isBorderBox = boxSizingNeeded && jQuery11.css(elem, "boxSizing", false, styles) === "border-box", valueIsBorderBox = isBorderBox, val = curCSS(elem, dimension, styles), offsetProp = "offset" + dimension[0].toUpperCase() + dimension.slice(1);
          ...
          !parseFloat(val) && jQuery11.css(elem, "display", false, styles) === "inline") && // Make sure the element is visible & connected
          elem.getClientRects().length) {
            isBorderBox = jQuery11.css(elem, "boxSizing", false, styles) === "border-box";
        ...
        jQuery11.extend({
          ...
          style: function(elem, name, value, extra) {
            ...
            hooks = jQuery11.cssHooks[name] || jQuery11.cssHooks[origName];
            if (value !== void 0) {
              type = typeof value;
              ...
              if (type === "number" && !isCustomProp) {
                value += ret && ret[3] || (jQuery11.cssNumber[origName] ? "" : "px");
              }
        ...
        jQuery11.each(["height", "width"], function(_i, dimension) {
          jQuery11.cssHooks[dimension] = {
            get: function(elem, computed, extra) {
              if (computed) {
                return rdisplayswap.test(jQuery11.css(elem, "display")) && // Support: Safari 8+
            ...
            set: function(elem, value, extra) {
              var matches, styles = getStyles(elem), scrollboxSizeBuggy = !support.scrollboxSize() && styles.position === "absolute", boxSizingNeeded = scrollboxSizeBuggy || extra, isBorderBox = boxSizingNeeded && jQuery11.css(elem, "boxSizing", false, styles) === "border-box", subtract = extra ? boxModelAdjustment(
                elem,
                dimension,
                extra,
                isBorderBox,
              ...
              if (subtract && (matches = rcssNum.exec(value)) && (matches[3] || "px") !== "px") {
                ...
                value = jQuery11.css(elem, dimension);
              }
              return setPositiveNumber(elem, value, subtract);
            }
          };
        });
        jQuery11.cssHooks.marginLeft = addGetHookIf(
        ...
        jQuery11.each({
          ...
          jQuery11.cssHooks[prefix + suffix] = {
          ...
          if (prefix !== "margin") {
            jQuery11.cssHooks[prefix + suffix].set = setPositiveNumber;
          }
        });
        jQuery11.fn.extend({
          css: function(name, value) {
            return access(this, function(elem, name2, value2) {
              ...
              if (Array.isArray(name2)) {
                ...
                len = name2.length;
                for (; i < len; i++) {
                  map[name2[i]] = jQuery11.css(elem, name2[i], false, styles);
                }
                return map;
              }
              return value2 !== void 0 ? jQuery11.style(elem, name2, value2) : jQuery11.css(elem, name2);
        ...
        jQuery11.Tween = Tween;
        Tween.prototype = {
          constructor: Tween,
          init: function(elem, options, prop, end2, easing, unit) {
            this.elem = elem;
            this.prop = prop;
            this.easing = easing || jQuery11.easing._default;
            this.options = options;
            this.start = this.now = this.cur();
            this.end = end2;
            this.unit = unit || (jQuery11.cssNumber[prop] ? "" : "px");
          },
          cur: function() {
          ...
          run: function(percent) {
            ...
            if (this.options.duration) {
              this.pos = eased = jQuery11.easing[this.easing](
                percent,
        ...
        Tween.propHooks = {
          _default: {
            get: function(tween) {
              ...
              result = jQuery11.css(tween.elem, tween.prop, "");
              return !result || result === "auto" ? 0 : result;
            },
            set: function(tween) {
              if (jQuery11.fx.step[tween.prop]) {
                jQuery11.fx.step[tween.prop](tween);
              } else if (tween.elem.nodeType === 1 && (jQuery11.cssHooks[tween.prop] || tween.elem.style[finalPropName(tween.prop)] != null)) {
                jQuery11.style(tween.elem, tween.prop, tween.now + tween.unit);
              } else {
        ...
        jQuery11.fx = Tween.prototype.init;
        jQuery11.fx.step = {};
        ...
        function schedule() {
          if (inProgress) {
            if (document2.hidden === false && window2.requestAnimationFrame) {
              ...
              window2.setTimeout(schedule, jQuery11.fx.interval);
            }
            jQuery11.fx.tick();
          }
        }
        ...
        function defaultPrefilter(elem, props, opts) {
          ...
          if (!opts.queue) {
            hooks = jQuery11._queueHooks(elem, "fx");
            ...
            anim.always(function() {
              anim.always(function() {
                hooks.unqueued--;
                if (!jQuery11.queue(elem, "fx").length) {
                  hooks.empty.fire();
                }
              });
            });
          ...
          for (prop in props) {
            ...
            if (rfxtypes.test(value)) {
              ...
              orig[prop] = dataShow && dataShow[prop] || jQuery11.style(elem, prop);
            }
          }
          propTween = !jQuery11.isEmptyObject(props);
          if (!propTween && jQuery11.isEmptyObject(orig)) {
            return;
          }
          if (isBox && elem.nodeType === 1) {
            ...
            display = jQuery11.css(elem, "display");
            if (display === "none") {
              if (restoreDisplay) {
            ...
            if (display === "inline" || display === "inline-block" && restoreDisplay != null) {
              if (jQuery11.css(elem, "float") === "none") {
                if (!propTween) {
                  anim.done(function() {
          ...
          for (prop in orig) {
            if (!propTween) {
              ...
              anim.done(function() {
                ...
                for (prop in orig) {
                  jQuery11.style(elem, prop, orig[prop]);
                }
              });
            }
        ...
        function Animation(elem, properties, options) {
          var result, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery11.Deferred().always(function() {
            delete tick.elem;
          }), tick = function() {
            if (stopped) {
              return false;
            ...
            elem,
            props: jQuery11.extend({}, properties),
            opts: jQuery11.extend(true, {
              specialEasing: {},
              easing: jQuery11.easing._default
            }, options),
          ...
          for (; index < length; index++) {
            ...
            if (result) {
              if (isFunction(result.stop)) {
                jQuery11._queueHooks(animation.elem, animation.opts.queue).stop = result.stop.bind(result);
              }
              return result;
            }
          }
          jQuery11.map(props, createTween, animation);
          if (isFunction(animation.opts.start)) {
            animation.opts.start.call(elem, animation);
          }
          animation.progress(animation.opts.progress).done(animation.opts.done, animation.opts.complete).fail(animation.opts.fail).always(animation.opts.always);
          jQuery11.fx.timer(
            jQuery11.extend(tick, {
              elem,
              anim: animation,
        ...
        jQuery11.Animation = jQuery11.extend(Animation, {
          tweeners: {
            "*": [function(prop, value) {
        ...
        jQuery11.speed = function(speed, easing, fn2) {
          var opt = speed && typeof speed === "object" ? jQuery11.extend({}, speed) : {
          ...
          if (jQuery11.fx.off) {
            ...
            if (typeof opt.duration !== "number") {
              if (opt.duration in jQuery11.fx.speeds) {
                opt.duration = jQuery11.fx.speeds[opt.duration];
              } else {
                opt.duration = jQuery11.fx.speeds._default;
              }
            }
          }
          ...
          opt.complete = function() {
            ...
            if (opt.queue) {
              jQuery11.dequeue(this, opt.queue);
            }
          };
          return opt;
        };
        jQuery11.fn.extend({
          ...
          animate: function(prop, speed, easing, callback) {
            var empty = jQuery11.isEmptyObject(prop), optall = jQuery11.speed(speed, easing, callback), doAnimation = function() {
              var anim = Animation(this, jQuery11.extend({}, prop), optall);
          ...
          stop: function(type, clearQueue, gotoEnd) {
            ...
            return this.each(function() {
              var dequeue = true, index = type != null && type + "queueHooks", timers = jQuery11.timers, data = dataPriv.get(this);
              if (index) {
          ...
          finish: function(type) {
            ...
            return this.each(function() {
              var index, data = dataPriv.get(this), queue = data[type + "queue"], hooks = data[type + "queueHooks"], timers = jQuery11.timers, length = queue ? queue.length : 0;
              data.finish = true;
              jQuery11.queue(this, type, []);
              if (hooks && hooks.stop) {
        ...
        jQuery11.each(["toggle", "show", "hide"], function(_i, name) {
          var cssFn = jQuery11.fn[name];
          jQuery11.fn[name] = function(speed, easing, callback) {
        ...
        jQuery11.timers = [];
        jQuery11.fx.tick = function() {
          var timer, i = 0, timers = jQuery11.timers;
          fxNow = Date.now();
        ...
        jQuery11.fx.timer = function(timer) {
          jQuery11.timers.push(timer);
          jQuery11.fx.start();
        };
        jQuery11.fx.interval = 13;
        jQuery11.fx.start = function() {
          if (inProgress) {
            return;
          }
          inProgress = true;
        ...
        jQuery11.fn.delay = function(time, type) {
          time = jQuery11.fx ? jQuery11.fx.speeds[time] || time : time;
          type = type || "fx";
        ...
        var boolHook, attrHandle = jQuery11.expr.attrHandle;
        jQuery11.fn.extend({
          attr: function(name, value) {
            return access(this, jQuery11.attr, name, value, arguments.length > 1);
          },
          removeAttr: function(name) {
            return this.each(function() {
              jQuery11.removeAttr(this, name);
            });
          }
        });
        jQuery11.extend({
          attr: function(elem, name, value) {
            ...
            if (typeof elem.getAttribute === "undefined") {
              return jQuery11.prop(elem, name, value);
            }
            if (nType !== 1 || !jQuery11.isXMLDoc(elem)) {
              hooks = jQuery11.attrHooks[name.toLowerCase()] || (jQuery11.expr.match.bool.test(name) ? boolHook : void 0);
            }
            if (value !== void 0) {
              if (value === null) {
                jQuery11.removeAttr(elem, name);
                return;
              }
            ...
            ret = jQuery11.find.attr(elem, name);
        ...
        jQuery11.each(jQuery11.expr.match.bool.source.match(/\w+/g), function(_i, name) {
          var getter = attrHandle[name] || jQuery11.find.attr;
        ...
        jQuery11.fn.extend({
          prop: function(name, value) {
            return access(this, jQuery11.prop, name, value, arguments.length > 1);
          },
          removeProp: function(name) {
            return this.each(function() {
              delete this[jQuery11.propFix[name] || name];
            });
          }
        });
        jQuery11.extend({
          prop: function(elem, name, value) {
            ...
            if (nType !== 1 || !jQuery11.isXMLDoc(elem)) {
              name = jQuery11.propFix[name] || name;
              hooks = jQuery11.propHooks[name];
            }
            if (value !== void 0) {
              if (hooks && "set" in hooks && (ret = hooks.set(elem, value, name)) !== void 0) {
                return ret;
          ...
          propHooks: {
            tabIndex: {
              get: function(elem) {
                var tabindex = jQuery11.find.attr(elem, "tabindex");
                if (tabindex) {
        ...
        jQuery11.each([
          ...
          jQuery11.propFix[this.toLowerCase()] = this;
        });
        ...
        jQuery11.fn.extend({
          addClass: function(value) {
            ...
            if (isFunction(value)) {
              return this.each(function(j) {
                jQuery11(this).addClass(value.call(this, j, getClass(this)));
              });
            }
          ...
          removeClass: function(value) {
            ...
            if (isFunction(value)) {
              return this.each(function(j) {
                jQuery11(this).removeClass(value.call(this, j, getClass(this)));
              });
            }
            if (!arguments.length) {
        ...
        jQuery11.fn.extend({
          val: function(value) {
            ...
            if (!arguments.length) {
              if (elem) {
                hooks = jQuery11.valHooks[elem.type] || jQuery11.valHooks[elem.nodeName.toLowerCase()];
            ...
            return this.each(function(i) {
              ...
              if (valueIsFunction) {
                val = value.call(this, i, jQuery11(this).val());
              } else {
                val = value;
              }
              if (val == null) {
                ...
                val = jQuery11.map(val, function(value2) {
                  return value2 == null ? "" : value2 + "";
                });
              }
              hooks = jQuery11.valHooks[this.type] || jQuery11.valHooks[this.nodeName.toLowerCase()];
        ...
        jQuery11.extend({
          valHooks: {
            option: {
              get: function(elem) {
                var val = jQuery11.find.attr(elem, "value");
                return val != null ? val : (
                  // Support: IE <=10 - 11 only
                  // option.text throws exceptions (trac-14686, trac-14858)
                  // Strip and collapse whitespace
                  // https://html.spec.whatwg.org/#strip-and-collapse-whitespace
                  stripAndCollapse(jQuery11.text(elem))
                );
              }
            },
            select: {
              ...
              set: function(elem, value) {
                var optionSet, option, options = elem.options, values = jQuery11.makeArray(value), i = options.length;
                while (i--) {
                  option = options[i];
                  if (option.selected = jQuery11.inArray(jQuery11.valHooks.option.get(option), values) > -1) {
                    optionSet = true;
                  }
                }
                if (!optionSet) {
        ...
        jQuery11.each(["radio", "checkbox"], function() {
          jQuery11.valHooks[this] = {
            set: function(elem, value) {
              if (Array.isArray(value)) {
                return elem.checked = jQuery11.inArray(jQuery11(elem).val(), value) > -1;
              }
            }
          };
          if (!support.checkOn) {
            jQuery11.valHooks[this].get = function(elem) {
        ...
        var rquery = /\?/;
        jQuery11.parseXML = function(data) {
          ...
          if (!xml || parserErrorElem) {
            jQuery11.error("Invalid XML: " + (parserErrorElem ? jQuery11.map(parserErrorElem.childNodes, function(el) {
        ...
        jQuery11.extend(jQuery11.event, {
          trigger: function(event, data, elem, onlyHandlers) {
            ...
            if (rfocusMorph.test(type + jQuery11.event.triggered)) {
              return;
            }
            if (type.indexOf(".") > -1) {
            ...
            event = event[jQuery11.expando] ? event : new jQuery11.Event(type, typeof event === "object" && event);
            ...
            data = data == null ? [event] : jQuery11.makeArray(data, [event]);
            special = jQuery11.event.special[type] || {};
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
              if ((!special._default || special._default.apply(eventPath.pop(), data) === false) && acceptData(elem)) {
                if (ontype && isFunction(elem[type]) && !isWindow(elem)) {
                  ...
                  jQuery11.event.triggered = void 0;
                  if (tmp) {
                    elem[ontype] = tmp;
                  }
                }
          ...
          simulate: function(type, elem, event) {
            ...
            jQuery11.event.trigger(e, null, elem);
          }
        });
        jQuery11.fn.extend({
          trigger: function(type, data) {
            return this.each(function() {
              jQuery11.event.trigger(type, data, this);
            });
          },
          triggerHandler: function(type, data) {
            var elem = this[0];
            if (elem) {
              return jQuery11.event.trigger(type, data, elem, true);
            }
          }
        });
        ...
        function buildParams(prefix, obj, traditional, add) {
          ...
          if (Array.isArray(obj)) {
            jQuery11.each(obj, function(i, v) {
        ...
        jQuery11.param = function(a, traditional) {
          ...
          if (Array.isArray(a) || a.jquery && !jQuery11.isPlainObject(a)) {
            jQuery11.each(a, function() {
        ...
        jQuery11.fn.extend({
          serialize: function() {
            return jQuery11.param(this.serializeArray());
          },
          serializeArray: function() {
            return this.map(function() {
              var elements = jQuery11.prop(this, "elements");
              return elements ? jQuery11.makeArray(elements) : this;
            }).filter(function() {
              var type = this.type;
              return this.name && !jQuery11(this).is(":disabled") && rsubmittable.test(this.nodeName) && !rsubmitterTypes.test(type) && (this.checked || !rcheckableType.test(type));
            }).map(function(_i, elem) {
              var val = jQuery11(this).val();
              if (val == null) {
                return null;
              }
              if (Array.isArray(val)) {
                return jQuery11.map(val, function(val2) {
        ...
        function inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR) {
          ...
          function inspect(dataType) {
            ...
            jQuery11.each(structure[dataType] || [], function(_, prefilterOrFactory) {
        ...
        function ajaxExtend(target, src) {
          var key, deep, flatOptions = jQuery11.ajaxSettings.flatOptions || {};
          for (key in src) {
            if (src[key] !== void 0) {
          ...
          if (deep) {
            jQuery11.extend(true, target, deep);
          }
          return target;
        }
        ...
        jQuery11.extend({
          ...
          ajaxSetup: function(target, settings) {
            return settings ? (
              ...
              ajaxExtend(ajaxExtend(target, jQuery11.ajaxSettings), settings)
            ) : (
              // Extending ajaxSettings
              ajaxExtend(jQuery11.ajaxSettings, target)
            );
          },
          ...
          ajax: function(url, options) {
            ...
            options = options || {};
            var transport, cacheURL, responseHeadersString, responseHeaders, timeoutTimer, urlAnchor, completed2, fireGlobals, i, uncached, s = jQuery11.ajaxSetup({}, options), callbackContext = s.context || s, globalEventContext = s.context && (callbackContext.nodeType || callbackContext.jquery) ? jQuery11(callbackContext) : jQuery11.event, deferred = jQuery11.Deferred(), completeDeferred = jQuery11.Callbacks("once memory"), statusCode = s.statusCode || {}, requestHeaders = {}, requestHeadersNames = {}, strAbort = "canceled", jqXHR = {
              readyState: 0,
            ...
            if (s.data && s.processData && typeof s.data !== "string") {
              s.data = jQuery11.param(s.data, s.traditional);
            }
            inspectPrefiltersOrTransports(prefilters, s, options, jqXHR);
            if (completed2) {
              return jqXHR;
            }
            fireGlobals = jQuery11.event && s.global;
            if (fireGlobals && jQuery11.active++ === 0) {
              jQuery11.event.trigger("ajaxStart");
            }
            ...
            if (s.ifModified) {
              if (jQuery11.lastModified[cacheURL]) {
                jqXHR.setRequestHeader("If-Modified-Since", jQuery11.lastModified[cacheURL]);
              }
              if (jQuery11.etag[cacheURL]) {
                jqXHR.setRequestHeader("If-None-Match", jQuery11.etag[cacheURL]);
              }
            }
            ...
            function done(status, nativeStatusText, responses, headers) {
              ...
              if (!isSuccess && jQuery11.inArray("script", s.dataTypes) > -1 && jQuery11.inArray("json", s.dataTypes) < 0) {
              ...
              if (isSuccess) {
                if (s.ifModified) {
                  ...
                  if (modified) {
                    jQuery11.lastModified[cacheURL] = modified;
                  }
                  modified = jqXHR.getResponseHeader("etag");
                  if (modified) {
                    jQuery11.etag[cacheURL] = modified;
                  }
                }
              ...
              if (fireGlobals) {
                ...
                if (!--jQuery11.active) {
                  jQuery11.event.trigger("ajaxStop");
                }
              }
            }
            return jqXHR;
          ...
          getJSON: function(url, data, callback) {
            return jQuery11.get(url, data, callback, "json");
          },
          getScript: function(url, callback) {
            return jQuery11.get(url, void 0, callback, "script");
          }
        });
        jQuery11.each(["get", "post"], function(_i, method) {
          jQuery11[method] = function(url, data, callback, type) {
            if (isFunction(data)) {
              type = type || callback;
              callback = data;
              data = void 0;
            }
            return jQuery11.ajax(jQuery11.extend({
              url,
              type: method,
              dataType: type,
              data,
              success: callback
            }, jQuery11.isPlainObject(url) && url));
          };
        });
        jQuery11.ajaxPrefilter(function(s) {
          var i;
          for (i in s.headers) {
        ...
        jQuery11._evalUrl = function(url, options, doc) {
          return jQuery11.ajax({
            url,
            ...
            dataFilter: function(response) {
              jQuery11.globalEval(response, options, doc);
            }
          });
        };
        jQuery11.fn.extend({
          wrapAll: function(html) {
            ...
            if (this[0]) {
              ...
              wrap = jQuery11(html, this[0].ownerDocument).eq(0).clone(true);
          ...
          wrapInner: function(html) {
            if (isFunction(html)) {
              return this.each(function(i) {
                jQuery11(this).wrapInner(html.call(this, i));
              });
            }
            return this.each(function() {
              var self2 = jQuery11(this), contents = self2.contents();
              if (contents.length) {
          ...
          wrap: function(html) {
            ...
            return this.each(function(i) {
              jQuery11(this).wrapAll(htmlIsFunction ? html.call(this, i) : html);
            });
          },
          unwrap: function(selector) {
            this.parent(selector).not("body").each(function() {
              jQuery11(this).replaceWith(this.childNodes);
            });
            return this;
          }
        });
        jQuery11.expr.pseudos.hidden = function(elem) {
          return !jQuery11.expr.pseudos.visible(elem);
        };
        jQuery11.expr.pseudos.visible = function(elem) {
          return !!(elem.offsetWidth || elem.offsetHeight || elem.getClientRects().length);
        };
        jQuery11.ajaxSettings.xhr = function() {
          try {
        ...
        var xhrSuccessStatus = {
          ...
          1223: 204
        }, xhrSupported = jQuery11.ajaxSettings.xhr();
        support.cors = !!xhrSupported && "withCredentials" in xhrSupported;
        support.ajax = xhrSupported = !!xhrSupported;
        jQuery11.ajaxTransport(function(options) {
        ...
        jQuery11.ajaxSetup({
          ...
          converters: {
            "text script": function(text) {
              jQuery11.globalEval(text);
              return text;
            }
          }
        });
        jQuery11.ajaxPrefilter("script", function(s) {
          if (s.cache === void 0) {
            s.cache = false;
          }
          if (s.crossDomain) {
        ...
        jQuery11.ajaxTransport("script", function(s) {
          if (s.crossDomain || s.scriptAttrs) {
            var script, callback;
            return {
              send: function(_, complete) {
                script = jQuery11("<script>").attr(s.scriptAttrs || {}).prop({ charset: s.scriptCharset, src: s.url }).on("load error", callback = function(evt) {
                  script.remove();
                  callback = null;
                  if (evt) {
        ...
        jQuery11.ajaxSetup({
          ...
          jsonpCallback: function() {
            var callback = oldCallbacks.pop() || jQuery11.expando + "_" + nonce.guid++;
            this[callback] = true;
            return callback;
          }
        });
        jQuery11.ajaxPrefilter("json jsonp", function(s, originalSettings, jqXHR) {
          ...
          if (jsonProp || s.dataTypes[0] === "jsonp") {
            ...
            s.converters["script json"] = function() {
              if (!responseContainer) {
                jQuery11.error(callbackName + " was not called");
              }
            ...
            jqXHR.always(function() {
              if (overwritten === void 0) {
                jQuery11(window2).removeProp(callbackName);
              } else {
        ...
        jQuery11.parseHTML = function(data, context, keepScripts) {
          if (typeof data !== "string") {
            return [];
          }
          ...
          if (scripts && scripts.length) {
            jQuery11(scripts).remove();
          }
          return jQuery11.merge([], parsed.childNodes);
        };
        jQuery11.fn.load = function(url, params, callback) {
          ...
          if (self2.length > 0) {
            jQuery11.ajax({
              ...
              self2.html(selector ? (
                ...
                jQuery11("<div>").append(jQuery11.parseHTML(responseText)).find(selector)
              ) : (
        ...
        jQuery11.expr.pseudos.animated = function(elem) {
          return jQuery11.grep(jQuery11.timers, function(fn2) {
            return elem === fn2.elem;
          }).length;
        };
        jQuery11.offset = {
          setOffset: function(elem, options, i) {
            var curPosition, curLeft, curCSSTop, curTop, curOffset, curCSSLeft, calculatePosition, position = jQuery11.css(elem, "position"), curElem = jQuery11(elem), props = {};
            if (position === "static") {
              elem.style.position = "relative";
            }
            curOffset = curElem.offset();
            curCSSTop = jQuery11.css(elem, "top");
            curCSSLeft = jQuery11.css(elem, "left");
            ...
            if (isFunction(options)) {
              options = options.call(elem, i, jQuery11.extend({}, curOffset));
            }
            if (options.top != null) {
        ...
        jQuery11.fn.extend({
          ...
          offset: function(options) {
            if (arguments.length) {
              return options === void 0 ? this : this.each(function(i) {
                jQuery11.offset.setOffset(this, options, i);
              });
            }
          ...
          position: function() {
            ...
            if (jQuery11.css(elem, "position") === "fixed") {
              offset2 = elem.getBoundingClientRect();
            } else {
              offset2 = this.offset();
              doc = elem.ownerDocument;
              offsetParent = elem.offsetParent || doc.documentElement;
              while (offsetParent && (offsetParent === doc.body || offsetParent === doc.documentElement) && jQuery11.css(offsetParent, "position") === "static") {
                offsetParent = offsetParent.parentNode;
              }
              if (offsetParent && offsetParent !== elem && offsetParent.nodeType === 1) {
                parentOffset = jQuery11(offsetParent).offset();
                parentOffset.top += jQuery11.css(offsetParent, "borderTopWidth", true);
                parentOffset.left += jQuery11.css(offsetParent, "borderLeftWidth", true);
              }
            }
            return {
              top: offset2.top - parentOffset.top - jQuery11.css(elem, "marginTop", true),
              left: offset2.left - parentOffset.left - jQuery11.css(elem, "marginLeft", true)
            };
          },
          ...
          offsetParent: function() {
            return this.map(function() {
              ...
              while (offsetParent && jQuery11.css(offsetParent, "position") === "static") {
        ...
        jQuery11.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(method, prop) {
          var top2 = "pageYOffset" === prop;
          jQuery11.fn[method] = function(val) {
        ...
        jQuery11.each(["top", "left"], function(_i, prop) {
          jQuery11.cssHooks[prop] = addGetHookIf(
            support.pixelPosition,
            function(elem, computed) {
              if (computed) {
                computed = curCSS(elem, prop);
                return rnumnonpx.test(computed) ? jQuery11(elem).position()[prop] + "px" : computed;
              }
            }
          );
        });
        jQuery11.each({ Height: "height", Width: "width" }, function(name, type) {
          jQuery11.each({
            padding: "inner" + name,
            content: type,
            "": "outer" + name
          }, function(defaultExtra, funcName) {
            jQuery11.fn[funcName] = function(margin, value) {
              ...
              return access(this, function(elem, type2, value2) {
                ...
                return value2 === void 0 ? (
                  ...
                  jQuery11.css(elem, type2, extra)
                ) : (
                  // Set width or height on the element
                  jQuery11.style(elem, type2, value2, extra)
                );
        ...
        jQuery11.each(
          ...
          function(_i, name) {
            jQuery11.fn[name] = function(data, fn2) {
              return arguments.length > 0 ? this.on(name, null, data, fn2) : this.trigger(name);
            };
          }
        );
        var rtrim = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;
        jQuery11.proxy = function(fn2, context) {
          var tmp, args, proxy;
          ...
          proxy.guid = fn2.guid = fn2.guid || jQuery11.guid++;
          return proxy;
        };
        jQuery11.holdReady = function(hold) {
          if (hold) {
            jQuery11.readyWait++;
          } else {
            jQuery11.ready(true);
        ...
        jQuery11.isArray = Array.isArray;
        jQuery11.parseJSON = JSON.parse;
        jQuery11.nodeName = nodeName;
        jQuery11.isFunction = isFunction;
        jQuery11.isWindow = isWindow;
        jQuery11.camelCase = camelCase;
        jQuery11.type = toType2;
        jQuery11.now = Date.now;
        jQuery11.isNumeric = function(obj) {
          var type = jQuery11.type(obj);
          return (type === "number" || type === "string") && // parseFloat NaNs numeric-cast false positives ("")
          // ...but misinterprets leading-number strings, particularly hex literals ("0x...")
          // subtraction forces infinities to NaN
          !isNaN(obj - parseFloat(obj));
        };
        jQuery11.trim = function(text) {
        ...
        jQuery11.noConflict = function(deep) {
          if (window2.$ === jQuery11) {
            window2.$ = _$;
          }
          if (deep && window2.jQuery === jQuery11) {
            window2.jQuery = _jQuery;
          }
          return jQuery11;
        };
        if (typeof noGlobal === "undefined") {
          window2.jQuery = window2.$ = jQuery11;
        }
        return jQuery11;
      });
    }
    ...
    $.widget("ra.filteringSelect", {
      ...
      _getSourceFunction: function(source) {
        ...
        if ($.isArray(source)) {
          return function(request, response) {
            response(self2._getResultSet(request, source, false));
          };
          ...
          return function(request, response) {
            ...
            this.xhr = $.ajax({
              url: source,
              data: self2.options.createQuery(request.term),
              dataType: "json",
              autocompleteRequest: ++requestIndex,
              success: function(data, status) {
                if (this.autocompleteRequest === requestIndex) {
                  response(self2._getResultSet(request, data, true));
                }
              },
              error: function() {
                if (this.autocompleteRequest === requestIndex) {
      ...
      _autocompleteDropdownEvent: function(element) {
        ...
        return element.click(function() {
          if (self2.input.autocomplete("widget").is(":visible")) {
            self2.input.autocomplete("close");
            return;
          }
          self2.input.autocomplete("search", "");
          self2.input.focus();
        });
      },
      ...
      _initAutocomplete: function() {
        ...
        return this.input.autocomplete({
          ...
          select: function(event, ui) {
            var option = self2.element.find(
              `option[value="${CSS.escape(ui.item.id)}"]`
            );
            self2.element.find("option[selected]").attr("selected", false);
            if (option.length > 0) {
              option.attr("selected", "selected");
            } else {
              option = $("<option>").attr("value", ui.item.id).attr("selected", true).text(ui.item.value);
              self2.element.append(option);
            }
            self2.element.trigger("change", ui.item.id);
            self2._trigger("selected", event, {
              item: option
            });
            $(self2.element.parents(".controls")[0]).find(".update").removeClass("disabled");
          },
          change: function(event, ui) {
            ...
            var valid = false;
            self2.element.children("option").each(function() {
            ...
            self2.input.data("ui-autocomplete").term = "";
            $(self2.element.parents(".controls")[0]).find(".update").addClass("disabled");
            return false;
          }
        });
      },
      _initKeyEvent: function() {
        ...
        return this.input.keyup(function() {
          ...
          return self2.element.html($('<option value="" selected="selected"></option>')).trigger("change");
        });
      },
